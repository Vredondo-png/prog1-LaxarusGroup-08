...
def programa_intercambio(parent, usuario):
    ...
    def mostrar_saldos():
        ...
        resultado_text.insert(2.0, f"ARS: {str(get_saldo('ARS'))}\n")
        resultado_text.insert(3.0, f"USD: {str(get_saldo('USD'))}\n")     
        resultado_text.insert(4.0, f"EUR: {str(get_saldo('EUR'))}\n")
    ...
    button_ejecutar.grid(row=0, column=0, padx=5)

    button_saldos = ttk.Button(button_frame, text="Ver Saldos", command=mostrar_saldos)
    button_saldos.grid(row=0, column=1, padx=5)
