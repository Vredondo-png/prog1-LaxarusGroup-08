...
def pago_servicios(cuenta, cuentas, idx, cuentas_file, movimientos, movimientos_file):
    ...
    def continuar():
        ...
        if servicio_actual:
            ...
            tk.Label(root, text=f"Saldo actual: ${cuenta['saldo']}", font=("Arial", 12)).pack(pady=5)
    ...
    def mostrar_menu():
        ...
        tk.Label(root, text=f"Saldo disponible: ${cuenta['saldo']}", font=("Arial", 12, "bold")).pack(pady=5)
