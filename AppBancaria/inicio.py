...
def abrir_pagina_cuenta(cuenta, cuentas_file, movimientos_file, parent=None):
    ...
    def abrir_pago_servicios():
        """Abre el módulo de pago de servicios con todos los parámetros necesarios"""
        pago_servicios(
            cuenta=cuenta,
            cuentas=cuentas,
            idx=idx,
    ...
    tk.Button(frame_btn, text="Deposito/Retiro", font=("Arial", 14, "bold"), 
              command=lambda: abrir_deposito_retiro(cuenta_win, cuenta, cuentas_file, movimientos_file),
